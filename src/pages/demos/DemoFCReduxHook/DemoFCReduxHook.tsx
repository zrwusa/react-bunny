...
import {demoHelloStateAction1} from "../../../stores/demo-state1/actions";
...
const DemoFCReduxHook: React.FunctionComponent<IRootState> = () => {
    ...
    return (<div>
        ...
        <button onClick={() => dispatch(demoHelloStateAction1({order:demoHelloState.order+1}))}>Dispatch something</button>
